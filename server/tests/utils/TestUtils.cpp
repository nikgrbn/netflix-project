...
TestUtils::TestUtils() : testData(), testPreparation() {
    ...
    testData["PATCH"] = {
        ...
        {{"PATCH", "2", "103", "106"}, "2 101 102 103 104 105 106"},
        {{"PATCH", "3", "102", "105", "107"}, "3 100 102 103 104 105 107 108"},
        {{"PATCH", "4", "101", "103", "106", "108"}, "4 100 101 103 105 106 107 109 110"},
        {{"PATCH", "5", "100", "104", "106", "109", "111"}, "5 100 102 103 104 105 106 108 111"},
        {{"PATCH", "6", "100", "105", "107", "110", "112", "113"}, "6 100 103 104 105 107 110 111 112 113"},
        {{"PATCH", "7", "100", "102", "104", "106", "108", "109", "110"}, "7 100 102 105 106 107 108 109 110"},
        {{"PATCH", "8", "100", "103", "105", "107", "109", "111", "114"}, "8 100 101 104 105 106 109 111 114"},
        {{"PATCH", "9", "100", "102", "105", "106", "107", "109", "110", "115"}, "9 100 103 105 107 112 113 115"},
        {{"PATCH", "10", "100", "102", "103", "105", "106", "107", "108", "109", "110", "116"}, "10 100 102 105 106 107 109 110 116"}
    };
}
